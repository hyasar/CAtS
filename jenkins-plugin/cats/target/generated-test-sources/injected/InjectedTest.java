...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:cats:1.0-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","/home/jingzes/CAtS/jenkins-plugin/cats");
    parameters.put("artifactId","cats");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","/home/jingzes/CAtS/jenkins-plugin/cats/target/classes");
    parameters.put("testOutputDirectory","/home/jingzes/CAtS/jenkins-plugin/cats/target/test-classes");
